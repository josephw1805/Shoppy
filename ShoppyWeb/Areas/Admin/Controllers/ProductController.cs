...
public class ProductController(IUnitOfWork unitOfWork, IWebHostEnvironment webHostEnvironment) : Controller
{
    ...
    if (ModelState.IsValid)
    {
      ...
      if (files != null)
      {
        foreach (IFormFile file in files)
        {
          ...
          if (productVM.Product.ProductImages == null) productVM.Product.ProductImages = [];
  ...
  public IActionResult DeleteImage(int itemId)
  {
    var imageToBeDeleted = _unitOfWork.ProductImage.Get(u => u.Id == itemId);
